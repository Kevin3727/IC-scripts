...
def DepositionPosition(self, frame, p, hitTime, recoName):
    ...
    if(up_norm > 250):
        return -1
    # [au_norm,up_norm*1.32, (hitTime - (frame[recoName].time + ((au_norm+(up_norm*1.32))/frame[recoName].speed))),(frame[recoName].time + ((au_norm+(up_norm*1.32))/frame[recoName].speed))]
