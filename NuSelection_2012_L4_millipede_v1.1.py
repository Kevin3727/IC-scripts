...
global clf4
clf4=joblib.load('/data/user/kevin/sterile/startingTrack/DataSelection/clf_AdaBoost_90percent_10vars/2012_clf4_AdaBoost_90percent_10vars_v1.pkl')
...
spline=np.genfromtxt('/data/user/kevin/sterile/startingTrack/paraboloidCorrectionSpline.dat')
...
import pickle
MuonEnergySpline = pickle.load( open( "/data/user/kevin/sterile/startingTrack/DataSelection/spline_dEdx2Emu.p", "rb" ) )
